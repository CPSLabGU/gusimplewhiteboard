...
#define GSW_NUM_TYPES_DEFINED 100
	...
	typedef enum wb_types
        {
                ...
                kHAL_RArmTarget_Ctrl_v = 98,	///< Used to control the right arm via DCM
                kHAL_RArmTarget_Stat_v = 99	///< Used to report DCM status of the right arm
