...
#define GSW_NUM_TYPES_DEFINED 81
...
//Generated by user: vlad
       ...
       typedef enum wb_types      
        {                                                               
                ...
                kMicrowaveStatus_v = 75,	///< Class for reading a simple microwave state
                kClocks_v = 76,	///< Class for keeping track of time
                kChannels_v = 77,	///< UPPAAL-Style synchronisation channels
                kToGear_v = 78,	///< Target gear number for Model Checking Case Study
                kFromGear_v = 79,	///< Current gear number for Model Checking Case Study
                kErrorStat_v = 80	///< Error status in Clutch for Model Checking Case Study
