...
#define GSW_NUM_TYPES_DEFINED 99
	...
	typedef enum wb_types
        {
                ...
                kDetect_Ball_wb_v = 96,	///< name of private wb for DetectBallColor machine
                kBall_Calibration_File_v = 97,	///< Name of DLC file to load
                kBall_Found_v = 98	///< Return value for DetectBallColor machine
