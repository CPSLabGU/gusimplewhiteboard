...
#define GSW_NUM_TYPES_DEFINED 102
	...
	typedef enum wb_types
        {
                ...
                kHAL_LArmTarget_Ctrl_v = 96,	///< Used to control the left arm via DCM
                kHAL_LArmTarget_Stat_v = 97,	///< Used to report DCM status of the left arm
                kHAL_LArmTarget_Tolr_v = 98,	///< Used to set the joing angle tolerance for motion completion detection.
                kHAL_RArmTarget_Ctrl_v = 99,	///< Used to control the right arm via DCM
                kHAL_RArmTarget_Stat_v = 100,	///< Used to report DCM status of the right arm
                kHAL_RArmTarget_Tolr_v = 101	///< Used to set the joing angle tolerance for motion completion detection.
