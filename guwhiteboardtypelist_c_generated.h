	...
	typedef enum wb_types
        {
                ...
                kBall_Calibration_File_v = 96,	///< Name of DLC file to load
                kBall_Calibration_Num_v = 97,	///< Number (size_t) to load with DLC file
                kBall_Color_Num_v = 98,	///< Number for each color as defined in STEM6Master
                kBall_Found_v = 99	///< Return value for DetectBallColor machine
