...
template <typename FOsighting_WBFunctor_T >
class FOsighting_WBFunctor: public WBFunctor<FOsighting_WBFunctor_T > 
{
public:
        FOsighting_WBFunctor(FOsighting_WBFunctor_T* obj, void (FOsighting_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &), guWhiteboard::WBTypes t): WBFunctor<FOsighting_WBFunctor_T >(obj, (void (FOsighting_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::FilteredOneDimObjects result = guWhiteboard::FOsighting_t().get_from(m);
                FOsighting_function_t funct((void (FOsighting_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &))WBFunctor<FOsighting_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<FOsighting_WBFunctor_T >::fObject->*funct)(WBFunctor<FOsighting_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (FOsighting_WBFunctor_T::*FOsighting_function_t) (guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &);

        static WBFunctorBase *bind(FOsighting_WBFunctor_T *obj, void (FOsighting_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &), guWhiteboard::WBTypes t) { return new FOsighting_WBFunctor<FOsighting_WBFunctor_T >(obj, f, t); }
};
