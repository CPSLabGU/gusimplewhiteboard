...
//Generated on: Sun Sep 13 23:13:53 2015
...
public:
        ...
        */
        ...
        /**
        * call method for callbacks, for class MicrowaveStatus_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
...
public:
        ...
        */
        ...
        /**
        * WBFunctor definition for ToGear_WBFunctor_T
        */
template <typename ToGear_WBFunctor_T >
class ToGear_WBFunctor: public WBFunctor<ToGear_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for ToGear_WBFunctor_T
        */
        ToGear_WBFunctor(ToGear_WBFunctor_T* obj, void (ToGear_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t): WBFunctor<ToGear_WBFunctor_T >(obj, (void (ToGear_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class ToGear_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                int result = guWhiteboard::ToGear_t().get_from(m);
                ToGear_function_t funct((void (ToGear_WBFunctor_T::*)(guWhiteboard::WBTypes, int &))WBFunctor<ToGear_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<ToGear_WBFunctor_T >::fObject->*funct)(WBFunctor<ToGear_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (ToGear_WBFunctor_T::*ToGear_function_t) (guWhiteboard::WBTypes, int &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(ToGear_WBFunctor_T *obj, void (ToGear_WBFunctor_T::*f)(guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t) { return new ToGear_WBFunctor<ToGear_WBFunctor_T >(obj, f, t); }
};
        ...
        /**
        * WBFunctor definition for FromGear_WBFunctor_T
        */
template <typename FromGear_WBFunctor_T >
class FromGear_WBFunctor: public WBFunctor<FromGear_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for FromGear_WBFunctor_T
        */
        FromGear_WBFunctor(FromGear_WBFunctor_T* obj, void (FromGear_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t): WBFunctor<FromGear_WBFunctor_T >(obj, (void (FromGear_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class FromGear_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                int result = guWhiteboard::FromGear_t().get_from(m);
                FromGear_function_t funct((void (FromGear_WBFunctor_T::*)(guWhiteboard::WBTypes, int &))WBFunctor<FromGear_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<FromGear_WBFunctor_T >::fObject->*funct)(WBFunctor<FromGear_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (FromGear_WBFunctor_T::*FromGear_function_t) (guWhiteboard::WBTypes, int &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(FromGear_WBFunctor_T *obj, void (FromGear_WBFunctor_T::*f)(guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t) { return new FromGear_WBFunctor<FromGear_WBFunctor_T >(obj, f, t); }
};
        ...
        /**
        * WBFunctor definition for ErrorStat_WBFunctor_T
        */
template <typename ErrorStat_WBFunctor_T >
class ErrorStat_WBFunctor: public WBFunctor<ErrorStat_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for ErrorStat_WBFunctor_T
        */
        ErrorStat_WBFunctor(ErrorStat_WBFunctor_T* obj, void (ErrorStat_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t): WBFunctor<ErrorStat_WBFunctor_T >(obj, (void (ErrorStat_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class ErrorStat_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                int result = guWhiteboard::ErrorStat_t().get_from(m);
                ErrorStat_function_t funct((void (ErrorStat_WBFunctor_T::*)(guWhiteboard::WBTypes, int &))WBFunctor<ErrorStat_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<ErrorStat_WBFunctor_T >::fObject->*funct)(WBFunctor<ErrorStat_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (ErrorStat_WBFunctor_T::*ErrorStat_function_t) (guWhiteboard::WBTypes, int &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(ErrorStat_WBFunctor_T *obj, void (ErrorStat_WBFunctor_T::*f)(guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t) { return new ErrorStat_WBFunctor<ErrorStat_WBFunctor_T >(obj, f, t); }
};
