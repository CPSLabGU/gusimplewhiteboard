...
template <typename SENSORS_LeftSonarSensors_WBFunctor_T >
class SENSORS_LeftSonarSensors_WBFunctor: public WBFunctor<SENSORS_LeftSonarSensors_WBFunctor_T > 
{
public:
        SENSORS_LeftSonarSensors_WBFunctor(SENSORS_LeftSonarSensors_WBFunctor_T* obj, void (SENSORS_LeftSonarSensors_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &), guWhiteboard::WBTypes t): WBFunctor<SENSORS_LeftSonarSensors_WBFunctor_T >(obj, (void (SENSORS_LeftSonarSensors_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::SENSORS_SonarSensors result = guWhiteboard::SENSORS_LeftSonarSensors_t().get_from(m);
                SENSORS_LeftSonarSensors_function_t funct((void (SENSORS_LeftSonarSensors_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &))WBFunctor<SENSORS_LeftSonarSensors_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<SENSORS_LeftSonarSensors_WBFunctor_T >::fObject->*funct)(WBFunctor<SENSORS_LeftSonarSensors_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (SENSORS_LeftSonarSensors_WBFunctor_T::*SENSORS_LeftSonarSensors_function_t) (guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &);

        static WBFunctorBase *bind(SENSORS_LeftSonarSensors_WBFunctor_T *obj, void (SENSORS_LeftSonarSensors_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &), guWhiteboard::WBTypes t) { return new SENSORS_LeftSonarSensors_WBFunctor<SENSORS_LeftSonarSensors_WBFunctor_T >(obj, f, t); }
};
...
{
public:
        FVOsighting_WBFunctor(FVOsighting_WBFunctor_T* obj, void (FVOsighting_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::FilteredVisionObjects &), guWhiteboard::WBTypes t): WBFunctor<FVOsighting_WBFunctor_T >(obj, (void (FVOsighting_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::FilteredVisionObjects result = guWhiteboard::FVOsighting_t().get_from(m);
                FVOsighting_function_t funct((void (FVOsighting_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::FilteredVisionObjects &))WBFunctor<FVOsighting_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<FVOsighting_WBFunctor_T >::fObject->*funct)(WBFunctor<FVOsighting_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (FVOsighting_WBFunctor_T::*FVOsighting_function_t) (guWhiteboard::WBTypes, guWhiteboard::FilteredVisionObjects &);

        static WBFunctorBase *bind(FVOsighting_WBFunctor_T *obj, void (FVOsighting_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::FilteredVisionObjects &), guWhiteboard::WBTypes t) { return new FVOsighting_WBFunctor<FVOsighting_WBFunctor_T >(obj, f, t); }
};
...
#ifdef SENSORS_SonarSensors_DEFINED
template <typename SENSORS_RightSonarSensors_WBFunctor_T >
class SENSORS_RightSonarSensors_WBFunctor: public WBFunctor<SENSORS_RightSonarSensors_WBFunctor_T > 
{
public:
        SENSORS_RightSonarSensors_WBFunctor(SENSORS_RightSonarSensors_WBFunctor_T* obj, void (SENSORS_RightSonarSensors_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &), guWhiteboard::WBTypes t): WBFunctor<SENSORS_RightSonarSensors_WBFunctor_T >(obj, (void (SENSORS_RightSonarSensors_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::SENSORS_SonarSensors result = guWhiteboard::SENSORS_RightSonarSensors_t().get_from(m);
                SENSORS_RightSonarSensors_function_t funct((void (SENSORS_RightSonarSensors_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &))WBFunctor<SENSORS_RightSonarSensors_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<SENSORS_RightSonarSensors_WBFunctor_T >::fObject->*funct)(WBFunctor<SENSORS_RightSonarSensors_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (SENSORS_RightSonarSensors_WBFunctor_T::*SENSORS_RightSonarSensors_function_t) (guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &);

        static WBFunctorBase *bind(SENSORS_RightSonarSensors_WBFunctor_T *obj, void (SENSORS_RightSonarSensors_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::SENSORS_SonarSensors &), guWhiteboard::WBTypes t) { return new SENSORS_RightSonarSensors_WBFunctor<SENSORS_RightSonarSensors_WBFunctor_T >(obj, f, t); }
};
