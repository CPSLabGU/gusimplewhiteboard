...
//Generated on: Tue May 14 11:13:10 2013
...
template <typename LoadGridMap_WBFunctor_T >
class LoadGridMap_WBFunctor: public WBFunctor<LoadGridMap_WBFunctor_T > 
{
public:
        LoadGridMap_WBFunctor(LoadGridMap_WBFunctor_T* obj, void (LoadGridMap_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<LoadGridMap_WBFunctor_T >(obj, (void (LoadGridMap_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::LoadGridMap_t().get_from(m);
                LoadGridMap_function_t funct((void (LoadGridMap_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<LoadGridMap_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<LoadGridMap_WBFunctor_T >::fObject->*funct)(WBFunctor<LoadGridMap_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (LoadGridMap_WBFunctor_T::*LoadGridMap_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(LoadGridMap_WBFunctor_T *obj, void (LoadGridMap_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new LoadGridMap_WBFunctor<LoadGridMap_WBFunctor_T >(obj, f, t); }
};



template <typename LoadDynamicPDDL_WBFunctor_T >
class LoadDynamicPDDL_WBFunctor: public WBFunctor<LoadDynamicPDDL_WBFunctor_T > 
{
public:
        LoadDynamicPDDL_WBFunctor(LoadDynamicPDDL_WBFunctor_T* obj, void (LoadDynamicPDDL_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<LoadDynamicPDDL_WBFunctor_T >(obj, (void (LoadDynamicPDDL_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::LoadDynamicPDDL_t().get_from(m);
                LoadDynamicPDDL_function_t funct((void (LoadDynamicPDDL_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<LoadDynamicPDDL_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<LoadDynamicPDDL_WBFunctor_T >::fObject->*funct)(WBFunctor<LoadDynamicPDDL_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (LoadDynamicPDDL_WBFunctor_T::*LoadDynamicPDDL_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(LoadDynamicPDDL_WBFunctor_T *obj, void (LoadDynamicPDDL_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new LoadDynamicPDDL_WBFunctor<LoadDynamicPDDL_WBFunctor_T >(obj, f, t); }
};



template <typename LoadPDDL_WBFunctor_T >
class LoadPDDL_WBFunctor: public WBFunctor<LoadPDDL_WBFunctor_T > 
{
public:
        LoadPDDL_WBFunctor(LoadPDDL_WBFunctor_T* obj, void (LoadPDDL_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<LoadPDDL_WBFunctor_T >(obj, (void (LoadPDDL_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::LoadPDDL_t().get_from(m);
                LoadPDDL_function_t funct((void (LoadPDDL_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<LoadPDDL_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<LoadPDDL_WBFunctor_T >::fObject->*funct)(WBFunctor<LoadPDDL_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (LoadPDDL_WBFunctor_T::*LoadPDDL_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(LoadPDDL_WBFunctor_T *obj, void (LoadPDDL_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new LoadPDDL_WBFunctor<LoadPDDL_WBFunctor_T >(obj, f, t); }
};



template <typename StartPlanner_WBFunctor_T >
class StartPlanner_WBFunctor: public WBFunctor<StartPlanner_WBFunctor_T > 
{
public:
        StartPlanner_WBFunctor(StartPlanner_WBFunctor_T* obj, void (StartPlanner_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<StartPlanner_WBFunctor_T >(obj, (void (StartPlanner_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::StartPlanner_t().get_from(m);
                StartPlanner_function_t funct((void (StartPlanner_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<StartPlanner_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<StartPlanner_WBFunctor_T >::fObject->*funct)(WBFunctor<StartPlanner_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (StartPlanner_WBFunctor_T::*StartPlanner_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(StartPlanner_WBFunctor_T *obj, void (StartPlanner_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new StartPlanner_WBFunctor<StartPlanner_WBFunctor_T >(obj, f, t); }
};



template <typename ExitModule_WBFunctor_T >
class ExitModule_WBFunctor: public WBFunctor<ExitModule_WBFunctor_T > 
{
public:
        ExitModule_WBFunctor(ExitModule_WBFunctor_T* obj, void (ExitModule_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<ExitModule_WBFunctor_T >(obj, (void (ExitModule_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::ExitModule_t().get_from(m);
                ExitModule_function_t funct((void (ExitModule_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<ExitModule_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<ExitModule_WBFunctor_T >::fObject->*funct)(WBFunctor<ExitModule_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (ExitModule_WBFunctor_T::*ExitModule_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(ExitModule_WBFunctor_T *obj, void (ExitModule_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new ExitModule_WBFunctor<ExitModule_WBFunctor_T >(obj, f, t); }
};



template <typename NextAction_WBFunctor_T >
class NextAction_WBFunctor: public WBFunctor<NextAction_WBFunctor_T > 
{
public:
        NextAction_WBFunctor(NextAction_WBFunctor_T* obj, void (NextAction_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<NextAction_WBFunctor_T >(obj, (void (NextAction_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::NextAction_t().get_from(m);
                NextAction_function_t funct((void (NextAction_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<NextAction_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<NextAction_WBFunctor_T >::fObject->*funct)(WBFunctor<NextAction_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (NextAction_WBFunctor_T::*NextAction_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(NextAction_WBFunctor_T *obj, void (NextAction_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new NextAction_WBFunctor<NextAction_WBFunctor_T >(obj, f, t); }
};



template <typename Replanning_WBFunctor_T >
class Replanning_WBFunctor: public WBFunctor<Replanning_WBFunctor_T > 
{
public:
        Replanning_WBFunctor(Replanning_WBFunctor_T* obj, void (Replanning_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<Replanning_WBFunctor_T >(obj, (void (Replanning_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::Replanning_t().get_from(m);
                Replanning_function_t funct((void (Replanning_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<Replanning_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<Replanning_WBFunctor_T >::fObject->*funct)(WBFunctor<Replanning_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (Replanning_WBFunctor_T::*Replanning_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(Replanning_WBFunctor_T *obj, void (Replanning_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new Replanning_WBFunctor<Replanning_WBFunctor_T >(obj, f, t); }
};



template <typename DoAll_WBFunctor_T >
class DoAll_WBFunctor: public WBFunctor<DoAll_WBFunctor_T > 
{
public:
        DoAll_WBFunctor(DoAll_WBFunctor_T* obj, void (DoAll_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<DoAll_WBFunctor_T >(obj, (void (DoAll_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::DoAll_t().get_from(m);
                DoAll_function_t funct((void (DoAll_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<DoAll_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<DoAll_WBFunctor_T >::fObject->*funct)(WBFunctor<DoAll_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (DoAll_WBFunctor_T::*DoAll_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(DoAll_WBFunctor_T *obj, void (DoAll_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new DoAll_WBFunctor<DoAll_WBFunctor_T >(obj, f, t); }
};



template <typename IsObstacleKnow_WBFunctor_T >
class IsObstacleKnow_WBFunctor: public WBFunctor<IsObstacleKnow_WBFunctor_T > 
{
public:
        IsObstacleKnow_WBFunctor(IsObstacleKnow_WBFunctor_T* obj, void (IsObstacleKnow_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<IsObstacleKnow_WBFunctor_T >(obj, (void (IsObstacleKnow_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::IsObstacleKnow_t().get_from(m);
                IsObstacleKnow_function_t funct((void (IsObstacleKnow_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<IsObstacleKnow_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<IsObstacleKnow_WBFunctor_T >::fObject->*funct)(WBFunctor<IsObstacleKnow_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (IsObstacleKnow_WBFunctor_T::*IsObstacleKnow_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(IsObstacleKnow_WBFunctor_T *obj, void (IsObstacleKnow_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new IsObstacleKnow_WBFunctor<IsObstacleKnow_WBFunctor_T >(obj, f, t); }
};



template <typename GeneratePolicy_WBFunctor_T >
class GeneratePolicy_WBFunctor: public WBFunctor<GeneratePolicy_WBFunctor_T > 
{
public:
        GeneratePolicy_WBFunctor(GeneratePolicy_WBFunctor_T* obj, void (GeneratePolicy_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<GeneratePolicy_WBFunctor_T >(obj, (void (GeneratePolicy_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::GeneratePolicy_t().get_from(m);
                GeneratePolicy_function_t funct((void (GeneratePolicy_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<GeneratePolicy_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<GeneratePolicy_WBFunctor_T >::fObject->*funct)(WBFunctor<GeneratePolicy_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (GeneratePolicy_WBFunctor_T::*GeneratePolicy_function_t) (guWhiteboard::WBTypes, std::string &);

        static WBFunctorBase *bind(GeneratePolicy_WBFunctor_T *obj, void (GeneratePolicy_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new GeneratePolicy_WBFunctor<GeneratePolicy_WBFunctor_T >(obj, f, t); }
};
