...
//Generated on: Sun Apr 28 15:16:17 2013
...
{
public:
        CustomClassExample_WBFunctor(CustomClassExample_WBFunctor_T* obj, void (CustomClassExample_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, bool &), guWhiteboard::WBTypes t): WBFunctor<CustomClassExample_WBFunctor_T >(obj, (void (CustomClassExample_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                bool result = guWhiteboard::CustomClassExample_t().get_from(m);
                CustomClassExample_function_t funct((void (CustomClassExample_WBFunctor_T::*)(guWhiteboard::WBTypes, bool &))WBFunctor<CustomClassExample_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<CustomClassExample_WBFunctor_T >::fObject->*funct)(WBFunctor<CustomClassExample_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (CustomClassExample_WBFunctor_T::*CustomClassExample_function_t) (guWhiteboard::WBTypes, bool &);

        static WBFunctorBase *bind(CustomClassExample_WBFunctor_T *obj, void (CustomClassExample_WBFunctor_T::*f)(guWhiteboard::WBTypes, bool &), guWhiteboard::WBTypes t) { return new CustomClassExample_WBFunctor<CustomClassExample_WBFunctor_T >(obj, f, t); }
};
