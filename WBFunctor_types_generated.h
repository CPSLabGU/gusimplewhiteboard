...
//Generated on: Thu Feb  4 21:24:34 2016
...
public:
        ...
        */
        ...
        /**
        * WBFunctor definition for TurnGreenEW_WBFunctor_T
        */
template <typename TurnGreenEW_WBFunctor_T >
class TurnGreenEW_WBFunctor: public WBFunctor<TurnGreenEW_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for TurnGreenEW_WBFunctor_T
        */
        TurnGreenEW_WBFunctor(TurnGreenEW_WBFunctor_T* obj, void (TurnGreenEW_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, bool &), guWhiteboard::WBTypes t): WBFunctor<TurnGreenEW_WBFunctor_T >(obj, (void (TurnGreenEW_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class TurnGreenEW_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                bool result = guWhiteboard::TurnGreenEW_t().get_from(m);
                TurnGreenEW_function_t funct((void (TurnGreenEW_WBFunctor_T::*)(guWhiteboard::WBTypes, bool &))WBFunctor<TurnGreenEW_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<TurnGreenEW_WBFunctor_T >::fObject->*funct)(WBFunctor<TurnGreenEW_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (TurnGreenEW_WBFunctor_T::*TurnGreenEW_function_t) (guWhiteboard::WBTypes, bool &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(TurnGreenEW_WBFunctor_T *obj, void (TurnGreenEW_WBFunctor_T::*f)(guWhiteboard::WBTypes, bool &), guWhiteboard::WBTypes t) { return new TurnGreenEW_WBFunctor<TurnGreenEW_WBFunctor_T >(obj, f, t); }
};
