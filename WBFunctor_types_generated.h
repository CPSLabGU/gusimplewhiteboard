...
template <typename Suspend_WBFunctor_T >
class Suspend_WBFunctor: public WBFunctor<Suspend_WBFunctor_T > 
{
public:
        Suspend_WBFunctor(Suspend_WBFunctor_T* obj, void (Suspend_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &), guWhiteboard::WBTypes t): WBFunctor<Suspend_WBFunctor_T >(obj, (void (Suspend_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::FSMControlStatus result = guWhiteboard::Suspend_t().get_from(m);
                Suspend_function_t funct((void (Suspend_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &))WBFunctor<Suspend_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<Suspend_WBFunctor_T >::fObject->*funct)(WBFunctor<Suspend_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (Suspend_WBFunctor_T::*Suspend_function_t) (guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &);

        static WBFunctorBase *bind(Suspend_WBFunctor_T *obj, void (Suspend_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &), guWhiteboard::WBTypes t) { return new Suspend_WBFunctor<Suspend_WBFunctor_T >(obj, f, t); }
};
...
#ifdef FSMControlStatus_DEFINED
template <typename Status_WBFunctor_T >
class Status_WBFunctor: public WBFunctor<Status_WBFunctor_T > 
{
public:
        Status_WBFunctor(Status_WBFunctor_T* obj, void (Status_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &), guWhiteboard::WBTypes t): WBFunctor<Status_WBFunctor_T >(obj, (void (Status_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::FSMControlStatus result = guWhiteboard::Status_t().get_from(m);
                Status_function_t funct((void (Status_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &))WBFunctor<Status_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<Status_WBFunctor_T >::fObject->*funct)(WBFunctor<Status_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (Status_WBFunctor_T::*Status_function_t) (guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &);

        static WBFunctorBase *bind(Status_WBFunctor_T *obj, void (Status_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::FSMControlStatus &), guWhiteboard::WBTypes t) { return new Status_WBFunctor<Status_WBFunctor_T >(obj, f, t); }
};
