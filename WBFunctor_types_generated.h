...
//Generated on: Wed Oct 22 15:31:34 2014
...
public:
        ...
        */
        ...
        /**
        * WBFunctor definition for Giraff_MainSerialInterface_WBFunctor_T
        */
template <typename Giraff_MainSerialInterface_WBFunctor_T >
class Giraff_MainSerialInterface_WBFunctor: public WBFunctor<Giraff_MainSerialInterface_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for Giraff_MainSerialInterface_WBFunctor_T
        */
        Giraff_MainSerialInterface_WBFunctor(Giraff_MainSerialInterface_WBFunctor_T* obj, void (Giraff_MainSerialInterface_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::Giraff_MainSerialInterface &), guWhiteboard::WBTypes t): WBFunctor<Giraff_MainSerialInterface_WBFunctor_T >(obj, (void (Giraff_MainSerialInterface_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class Giraff_MainSerialInterface_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                guWhiteboard::Giraff_MainSerialInterface result = guWhiteboard::Giraff_MainSerialInterface_t().get_from(m);
                Giraff_MainSerialInterface_function_t funct((void (Giraff_MainSerialInterface_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::Giraff_MainSerialInterface &))WBFunctor<Giraff_MainSerialInterface_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<Giraff_MainSerialInterface_WBFunctor_T >::fObject->*funct)(WBFunctor<Giraff_MainSerialInterface_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (Giraff_MainSerialInterface_WBFunctor_T::*Giraff_MainSerialInterface_function_t) (guWhiteboard::WBTypes, guWhiteboard::Giraff_MainSerialInterface &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(Giraff_MainSerialInterface_WBFunctor_T *obj, void (Giraff_MainSerialInterface_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::Giraff_MainSerialInterface &), guWhiteboard::WBTypes t) { return new Giraff_MainSerialInterface_WBFunctor<Giraff_MainSerialInterface_WBFunctor_T >(obj, f, t); }
};
