...
//Generated on: Fri Jul 31 19:24:50 2015
...
public:
        ...
        */
        ...
        /**
        * WBFunctor definition for 3DInput_WBFunctor_T
        */
template <typename 3DInput_WBFunctor_T >
class 3DInput_WBFunctor: public WBFunctor<3DInput_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for 3DInput_WBFunctor_T
        */
        3DInput_WBFunctor(3DInput_WBFunctor_T* obj, void (3DInput_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::3DInput &), guWhiteboard::WBTypes t): WBFunctor<3DInput_WBFunctor_T >(obj, (void (3DInput_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class 3DInput_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                guWhiteboard::3DInput result = guWhiteboard::3DInput_t().get_from(m);
                3DInput_function_t funct((void (3DInput_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::3DInput &))WBFunctor<3DInput_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<3DInput_WBFunctor_T >::fObject->*funct)(WBFunctor<3DInput_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (3DInput_WBFunctor_T::*3DInput_function_t) (guWhiteboard::WBTypes, guWhiteboard::3DInput &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(3DInput_WBFunctor_T *obj, void (3DInput_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::3DInput &), guWhiteboard::WBTypes t) { return new 3DInput_WBFunctor<3DInput_WBFunctor_T >(obj, f, t); }
};
