...
//Generated on: Wed Apr 17 14:56:35 2013
...
#ifdef MOTION_SDK_Commands_DEFINED
...
{
public:
        MOTION_SDK_Commands_WBFunctor(MOTION_SDK_Commands_WBFunctor_T* obj, void (MOTION_SDK_Commands_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::MOTION_SDK_Commands &), guWhiteboard::WBTypes t): WBFunctor<MOTION_SDK_Commands_WBFunctor_T >(obj, (void (MOTION_SDK_Commands_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::MOTION_SDK_Commands result = guWhiteboard::MOTION_SDK_Commands_t().get_from(m);
                MOTION_SDK_Commands_function_t funct((void (MOTION_SDK_Commands_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::MOTION_SDK_Commands &))WBFunctor<MOTION_SDK_Commands_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<MOTION_SDK_Commands_WBFunctor_T >::fObject->*funct)(WBFunctor<MOTION_SDK_Commands_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (MOTION_SDK_Commands_WBFunctor_T::*MOTION_SDK_Commands_function_t) (guWhiteboard::WBTypes, guWhiteboard::MOTION_SDK_Commands &);

        static WBFunctorBase *bind(MOTION_SDK_Commands_WBFunctor_T *obj, void (MOTION_SDK_Commands_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::MOTION_SDK_Commands &), guWhiteboard::WBTypes t) { return new MOTION_SDK_Commands_WBFunctor<MOTION_SDK_Commands_WBFunctor_T >(obj, f, t); }
};
