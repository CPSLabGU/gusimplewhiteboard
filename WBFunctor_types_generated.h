...
{
public:
        FVOsighting_WBFunctor(FVOsighting_WBFunctor_T* obj, void (FVOsighting_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &), guWhiteboard::WBTypes t): WBFunctor<FVOsighting_WBFunctor_T >(obj, (void (FVOsighting_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::FilteredOneDimObjects result = guWhiteboard::FVOsighting_t().get_from(m);
                FVOsighting_function_t funct((void (FVOsighting_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &))WBFunctor<FVOsighting_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<FVOsighting_WBFunctor_T >::fObject->*funct)(WBFunctor<FVOsighting_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (FVOsighting_WBFunctor_T::*FVOsighting_function_t) (guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &);

        static WBFunctorBase *bind(FVOsighting_WBFunctor_T *obj, void (FVOsighting_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &), guWhiteboard::WBTypes t) { return new FVOsighting_WBFunctor<FVOsighting_WBFunctor_T >(obj, f, t); }
};
