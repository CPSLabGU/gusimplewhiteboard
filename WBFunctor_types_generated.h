...
//Generated on: Mon Jun 16 17:16:29 2014
...
template <typename dummy_WBFunctor_T >
class dummy_WBFunctor: public WBFunctor<dummy_WBFunctor_T > 
{
public:
        dummy_WBFunctor(dummy_WBFunctor_T* obj, void (dummy_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t): WBFunctor<dummy_WBFunctor_T >(obj, (void (dummy_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                int result = guWhiteboard::dummy_t().get_from(m);
                dummy_function_t funct((void (dummy_WBFunctor_T::*)(guWhiteboard::WBTypes, int &))WBFunctor<dummy_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<dummy_WBFunctor_T >::fObject->*funct)(WBFunctor<dummy_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (dummy_WBFunctor_T::*dummy_function_t) (guWhiteboard::WBTypes, int &);

        static WBFunctorBase *bind(dummy_WBFunctor_T *obj, void (dummy_WBFunctor_T::*f)(guWhiteboard::WBTypes, int &), guWhiteboard::WBTypes t) { return new dummy_WBFunctor<dummy_WBFunctor_T >(obj, f, t); }
};
...
{
public:
        FilteredBallSighting_WBFunctor(FilteredBallSighting_WBFunctor_T* obj, void (FilteredBallSighting_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &), guWhiteboard::WBTypes t): WBFunctor<FilteredBallSighting_WBFunctor_T >(obj, (void (FilteredBallSighting_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::FilteredOneDimObjects result = guWhiteboard::FilteredBallSighting_t().get_from(m);
                FilteredBallSighting_function_t funct((void (FilteredBallSighting_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &))WBFunctor<FilteredBallSighting_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<FilteredBallSighting_WBFunctor_T >::fObject->*funct)(WBFunctor<FilteredBallSighting_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (FilteredBallSighting_WBFunctor_T::*FilteredBallSighting_function_t) (guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &);

        static WBFunctorBase *bind(FilteredBallSighting_WBFunctor_T *obj, void (FilteredBallSighting_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::FilteredOneDimObjects &), guWhiteboard::WBTypes t) { return new FilteredBallSighting_WBFunctor<FilteredBallSighting_WBFunctor_T >(obj, f, t); }
};
