...
/** WBFunctor definition for Sonar1Data_WBFunctor_T */ 
template <typename Sonar1Data_WBFunctor_T >
class Sonar1Data_WBFunctor: public WBFunctor<Sonar1Data_WBFunctor_T > {
public:
    /** WBFunctor constructor for Sonar1Data_WBFunctor_T */
    Sonar1Data_WBFunctor(Sonar1Data_WBFunctor_T* obj, void (Sonar1Data_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::SonarData &), guWhiteboard::WBTypes t): WBFunctor<Sonar1Data_WBFunctor_T >(obj, (void (Sonar1Data_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

    /** call method for callbacks, for class Sonar1Data_WBFunctor */
    void call(gu_simple_message *m) {
        guWhiteboard::SonarData result = guWhiteboard::Sonar1Data_t().get_from(m);
        Sonar1Data_function_t funct((void (Sonar1Data_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::SonarData &))WBFunctor<Sonar1Data_WBFunctor_T >::get_s_func_ptr());
        (WBFunctor<Sonar1Data_WBFunctor_T >::fObject->*funct)(WBFunctor<Sonar1Data_WBFunctor_T >::type_enum, result);
    }

    /** define callback signature */
    typedef void (Sonar1Data_WBFunctor_T::*Sonar1Data_function_t) (guWhiteboard::WBTypes, guWhiteboard::SonarData &);

    /** internal method of linking classes */
    static WBFunctorBase *bind(Sonar1Data_WBFunctor_T *obj, void (Sonar1Data_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::SonarData &), guWhiteboard::WBTypes t) { return new Sonar1Data_WBFunctor<Sonar1Data_WBFunctor_T >(obj, f, t); }
}; 
#endif //SonarData_DEFINED

#ifdef SonarData_DEFINED
/** WBFunctor definition for Sonar2Data_WBFunctor_T */ 
template <typename Sonar2Data_WBFunctor_T >
class Sonar2Data_WBFunctor: public WBFunctor<Sonar2Data_WBFunctor_T > {
public:
    /** WBFunctor constructor for Sonar2Data_WBFunctor_T */
    Sonar2Data_WBFunctor(Sonar2Data_WBFunctor_T* obj, void (Sonar2Data_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::SonarData &), guWhiteboard::WBTypes t): WBFunctor<Sonar2Data_WBFunctor_T >(obj, (void (Sonar2Data_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

    /** call method for callbacks, for class Sonar2Data_WBFunctor */
    void call(gu_simple_message *m) {
        guWhiteboard::SonarData result = guWhiteboard::Sonar2Data_t().get_from(m);
        Sonar2Data_function_t funct((void (Sonar2Data_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::SonarData &))WBFunctor<Sonar2Data_WBFunctor_T >::get_s_func_ptr());
        (WBFunctor<Sonar2Data_WBFunctor_T >::fObject->*funct)(WBFunctor<Sonar2Data_WBFunctor_T >::type_enum, result);
    }

    /** define callback signature */
    typedef void (Sonar2Data_WBFunctor_T::*Sonar2Data_function_t) (guWhiteboard::WBTypes, guWhiteboard::SonarData &);

    /** internal method of linking classes */
    static WBFunctorBase *bind(Sonar2Data_WBFunctor_T *obj, void (Sonar2Data_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::SonarData &), guWhiteboard::WBTypes t) { return new Sonar2Data_WBFunctor<Sonar2Data_WBFunctor_T >(obj, f, t); }
}; 
#endif //SonarData_DEFINED

#ifdef SonarData_DEFINED
/** WBFunctor definition for Sonar3Data_WBFunctor_T */ 
template <typename Sonar3Data_WBFunctor_T >
class Sonar3Data_WBFunctor: public WBFunctor<Sonar3Data_WBFunctor_T > {
public:
    /** WBFunctor constructor for Sonar3Data_WBFunctor_T */
    Sonar3Data_WBFunctor(Sonar3Data_WBFunctor_T* obj, void (Sonar3Data_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::SonarData &), guWhiteboard::WBTypes t): WBFunctor<Sonar3Data_WBFunctor_T >(obj, (void (Sonar3Data_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

    /** call method for callbacks, for class Sonar3Data_WBFunctor */
    void call(gu_simple_message *m) {
        guWhiteboard::SonarData result = guWhiteboard::Sonar3Data_t().get_from(m);
        Sonar3Data_function_t funct((void (Sonar3Data_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::SonarData &))WBFunctor<Sonar3Data_WBFunctor_T >::get_s_func_ptr());
        (WBFunctor<Sonar3Data_WBFunctor_T >::fObject->*funct)(WBFunctor<Sonar3Data_WBFunctor_T >::type_enum, result);
    }

    /** define callback signature */
    typedef void (Sonar3Data_WBFunctor_T::*Sonar3Data_function_t) (guWhiteboard::WBTypes, guWhiteboard::SonarData &);

    /** internal method of linking classes */
    static WBFunctorBase *bind(Sonar3Data_WBFunctor_T *obj, void (Sonar3Data_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::SonarData &), guWhiteboard::WBTypes t) { return new Sonar3Data_WBFunctor<Sonar3Data_WBFunctor_T >(obj, f, t); }
}; 
#endif //SonarData_DEFINED
