...
//Generated on: Fri Nov  8 17:58:26 2013
//Generated by user: tbpotwww
...
template <typename WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T >
class WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor: public WBFunctor<WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T > 
{
public:
        WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor(WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T* obj, void (WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::WEBOTS_NXT_deadReakoning_walk_isRunning &), guWhiteboard::WBTypes t): WBFunctor<WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T >(obj, (void (WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        void call(gu_simple_message *m)
        {
                guWhiteboard::WEBOTS_NXT_deadReakoning_walk_isRunning result = guWhiteboard::WEBOTS_NXT_deadReakoning_walk_isRunning_t().get_from(m);
                WEBOTS_NXT_deadReakoning_walk_isRunning_function_t funct((void (WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::WEBOTS_NXT_deadReakoning_walk_isRunning &))WBFunctor<WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T >::fObject->*funct)(WBFunctor<WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T >::type_enum, result);
        }
        
        typedef void (WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T::*WEBOTS_NXT_deadReakoning_walk_isRunning_function_t) (guWhiteboard::WBTypes, guWhiteboard::WEBOTS_NXT_deadReakoning_walk_isRunning &);

        static WBFunctorBase *bind(WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T *obj, void (WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::WEBOTS_NXT_deadReakoning_walk_isRunning &), guWhiteboard::WBTypes t) { return new WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor<WEBOTS_NXT_deadReakoning_walk_isRunning_WBFunctor_T >(obj, f, t); }
};
