...
//Generated on: Wed Sep 10 14:28:30 2014
...
public:
        ...
        */
        XEyesPos_WBFunctor(XEyesPos_WBFunctor_T* obj, void (XEyesPos_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::vector<int> &), guWhiteboard::WBTypes t): WBFunctor<XEyesPos_WBFunctor_T >(obj, (void (XEyesPos_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }
        ...
        */
        void call(gu_simple_message *m)
        {
                std::vector<int> result = guWhiteboard::XEyesPos_t().get_from(m);
                XEyesPos_function_t funct((void (XEyesPos_WBFunctor_T::*)(guWhiteboard::WBTypes, std::vector<int> &))WBFunctor<XEyesPos_WBFunctor_T >::get_s_func_ptr());
        ...
        * define callback signature
        */
        typedef void (XEyesPos_WBFunctor_T::*XEyesPos_function_t) (guWhiteboard::WBTypes, std::vector<int> &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(XEyesPos_WBFunctor_T *obj, void (XEyesPos_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::vector<int> &), guWhiteboard::WBTypes t) { return new XEyesPos_WBFunctor<XEyesPos_WBFunctor_T >(obj, f, t); }
};
