...
//Generated on: Mon Nov 23 23:56:26 2015
...
public:
        ...
        */
        ...
        /**
        * WBFunctor definition for Switch_Subsumption_WBFunctor_T
        */
template <typename Switch_Subsumption_WBFunctor_T >
class Switch_Subsumption_WBFunctor: public WBFunctor<Switch_Subsumption_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for Switch_Subsumption_WBFunctor_T
        */
        Switch_Subsumption_WBFunctor(Switch_Subsumption_WBFunctor_T* obj, void (Switch_Subsumption_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, guWhiteboard::Switch_Subsumption &), guWhiteboard::WBTypes t): WBFunctor<Switch_Subsumption_WBFunctor_T >(obj, (void (Switch_Subsumption_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class Switch_Subsumption_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                guWhiteboard::Switch_Subsumption result = guWhiteboard::Switch_Subsumption_t().get_from(m);
                Switch_Subsumption_function_t funct((void (Switch_Subsumption_WBFunctor_T::*)(guWhiteboard::WBTypes, guWhiteboard::Switch_Subsumption &))WBFunctor<Switch_Subsumption_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<Switch_Subsumption_WBFunctor_T >::fObject->*funct)(WBFunctor<Switch_Subsumption_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (Switch_Subsumption_WBFunctor_T::*Switch_Subsumption_function_t) (guWhiteboard::WBTypes, guWhiteboard::Switch_Subsumption &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(Switch_Subsumption_WBFunctor_T *obj, void (Switch_Subsumption_WBFunctor_T::*f)(guWhiteboard::WBTypes, guWhiteboard::Switch_Subsumption &), guWhiteboard::WBTypes t) { return new Switch_Subsumption_WBFunctor<Switch_Subsumption_WBFunctor_T >(obj, f, t); }
};
