...
public:
        ...
        */
        ...
        /**
        * WBFunctor definition for Detect_Ball_wb_WBFunctor_T
        */
template <typename Detect_Ball_wb_WBFunctor_T >
class Detect_Ball_wb_WBFunctor: public WBFunctor<Detect_Ball_wb_WBFunctor_T > 
{
public:
        
        /**
        * WBFunctor constructor for Detect_Ball_wb_WBFunctor_T
        */
        Detect_Ball_wb_WBFunctor(Detect_Ball_wb_WBFunctor_T* obj, void (Detect_Ball_wb_WBFunctor_T::*pFunc) (guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t): WBFunctor<Detect_Ball_wb_WBFunctor_T >(obj, (void (Detect_Ball_wb_WBFunctor_T::*) (guWhiteboard::WBTypes, gu_simple_message*))pFunc, t) { }

        
        /**
        * call method for callbacks, for class Detect_Ball_wb_WBFunctor_T
        */
        void call(gu_simple_message *m)
        {
                std::string result = guWhiteboard::Detect_Ball_wb_t().get_from(m);
                Detect_Ball_wb_function_t funct((void (Detect_Ball_wb_WBFunctor_T::*)(guWhiteboard::WBTypes, std::string &))WBFunctor<Detect_Ball_wb_WBFunctor_T >::get_s_func_ptr());
                (WBFunctor<Detect_Ball_wb_WBFunctor_T >::fObject->*funct)(WBFunctor<Detect_Ball_wb_WBFunctor_T >::type_enum, result);
        }
        
        /**
        * define callback signature
        */
        typedef void (Detect_Ball_wb_WBFunctor_T::*Detect_Ball_wb_function_t) (guWhiteboard::WBTypes, std::string &);

        
        /**
        * internal method of linking classes 
        */
        static WBFunctorBase *bind(Detect_Ball_wb_WBFunctor_T *obj, void (Detect_Ball_wb_WBFunctor_T::*f)(guWhiteboard::WBTypes, std::string &), guWhiteboard::WBTypes t) { return new Detect_Ball_wb_WBFunctor<Detect_Ball_wb_WBFunctor_T >(obj, f, t); }
};
