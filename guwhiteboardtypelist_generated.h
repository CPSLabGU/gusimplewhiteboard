...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///Suspend, Resume, or Restart a finite state machine (clfsm)
        class Suspend_t: public generic_whiteboard_object<class FSMControlStatus > { public: Suspend_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FSMControlStatus >(wbd, kSuspend_v) {} };

	///Current status indicating the running state of all FSMs.  The highest bit that is always set is the number of machines plus one.
        class Status_t: public generic_whiteboard_object<class FSMControlStatus > { public: Status_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FSMControlStatus >(wbd, kStatus_v) {} };
