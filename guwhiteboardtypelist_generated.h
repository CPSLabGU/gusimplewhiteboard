...
#include "guwhiteboardtypelist_c_generated.h"
	...
	/** WB Ptr Class: Detect_Ball_wb @brief name of private wb for DetectBallColor machine */ 
        class Detect_Ball_wb_t: public generic_whiteboard_object<std::string > { 
	public: 
		/** Constructor: Detect_Ball_wb */ 
		Detect_Ball_wb_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kDetect_Ball_wb_v, false) {}
		/** Constructor: Detect_Ball_wb */ 
		Detect_Ball_wb_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kDetect_Ball_wb_v, wbd, false) {} 
	};
