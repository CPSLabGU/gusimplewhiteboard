...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: Giraff_MainSerialInterface @brief Serial interface for the main motor and sensor board of the giraff */ 
        ...
        class Giraff_MainSerialInterface_t: public generic_whiteboard_object<class Giraff_MainSerialInterface > { 
	public: 
		/** Constructor: Giraff_MainSerialInterface */ 
		Giraff_MainSerialInterface_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class Giraff_MainSerialInterface >(wbd, kGiraff_MainSerialInterface_v, false) {} 
	};
