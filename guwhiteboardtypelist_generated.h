...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: TurnGreenEW @brief third status of the recommendaiton of the EW light */ 
        class TurnGreenEW_t: public generic_whiteboard_object<bool > { 
	public: 
		/** Constructor: TurnGreenEW */ 
		TurnGreenEW_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<bool >(wbd, kTurnGreenEW_v, false) {}
		/** Constructor: TurnGreenEW */ 
		TurnGreenEW_t(bool value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<bool >(value, kTurnGreenEW_v, wbd, false) {} 
	};
