...
//Generated on: Fri Jun 21 12:21:30 2013
...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///game state as posted by the game controller state machine
        class GCGameState_t: public generic_whiteboard_object<class GCGameState > { public: GCGameState_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class GCGameState >(wbd, kGCGameState_v, false) {} };
	...
	///Class that contains the Kalman filtered goal objects after sighting from vision
        class FilteredGoalSighting_t: public generic_whiteboard_object<class FilteredOneDimObjects > { public: FilteredGoalSighting_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FilteredOneDimObjects >(wbd, kFilteredGoalSighting_v, false) {} };
	...
	///game state notfication from the UDP receiver.
        class UDPRN_t: public generic_whiteboard_object<class GCGameState > { public: UDPRN_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class GCGameState >(wbd, kUDPRN_v, false) {} };
	...
	///Class that contains the top particles for possible robot positions
        class TopParticles_t: public generic_whiteboard_object<class TopParticles > { public: TopParticles_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class TopParticles >(wbd, kTopParticles_v, false) {} };

	///Class that contains the Kalman filtered ball object after sighting from vision
        class FilteredBallSighting_t: public generic_whiteboard_object<class FilteredVisionObject > { public: FilteredBallSighting_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FilteredVisionObject >(wbd, kFilteredBallSighting_v, false) {} };

	/// what to post in the whiteboard to cause the Particle Filetr to reset, but running has no effect, it is the PF response
        class PF_ControlStatus_Modes_t: public generic_whiteboard_object<int > { public: PF_ControlStatus_Modes_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kPF_ControlStatus_Modes_v, false) {}
