...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///WB interface for sending motion commands to the SDK
        class MOTION_SDK_Commands_t: public generic_whiteboard_object<class MOTION_SDK_Interface > { 
	public: 
		MOTION_SDK_Commands_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class MOTION_SDK_Interface >(wbd, kMOTION_SDK_Commands_v, false) {} 
	};

	///WB interface for sending motion commands to the SDK
        class MOTION_SDK_Commands_iTCP: public injection_whiteboard_object<class MOTION_SDK_Interface > { 
	public: 
		MOTION_SDK_Commands_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class MOTION_SDK_Interface >(hostname, kMOTION_SDK_Commands_v, is_async) {} 
	};

	///WB interface for checking the status of commands sent to the SDK
        class MOTION_SDK_Status_t: public generic_whiteboard_object<class MOTION_SDK_Interface > { 
	public: 
		MOTION_SDK_Status_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class MOTION_SDK_Interface >(wbd, kMOTION_SDK_Status_v, false) {} 
	};

	///WB interface for checking the status of commands sent to the SDK
        class MOTION_SDK_Status_iTCP: public injection_whiteboard_object<class MOTION_SDK_Interface > { 
	public: 
		MOTION_SDK_Status_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class MOTION_SDK_Interface >(hostname, kMOTION_SDK_Status_v, is_async) {} 
	};
