...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///Class that contains the Karman filtered  information of objects sightings
        class FOsighting_t: public generic_whiteboard_object<class FilteredOneDimObjects > { public: FOsighting_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FilteredOneDimObjects >(wbd, kFOsighting_v, false) {} };
