...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: DifferentialRobotStatus @brief Class that reads differential robot status */ 
        ...
        class DifferentialRobotStatus_t: public generic_whiteboard_object<class DifferentialRobotStatus > { 
	public: 
		/** Constructor: DifferentialRobotStatus */ 
		DifferentialRobotStatus_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class DifferentialRobotStatus >(wbd, kDifferentialRobotStatus_v, false) {} 
	};
