...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///Class that contains the Klamna filtered  information of an object sigthing
        class FVOsighting_t: public generic_whiteboard_object<class FilteredVisionObject > { public: FVOsighting_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FilteredVisionObject >(wbd, kFVOsighting_v, false) {} };
	...
	/// Load a new GridMap, in the content you must write the GridMap name
        class LoadGridMap_t: public generic_whiteboard_object<std::string > { public: LoadGridMap_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kLoadGridMap_v, true) {}
		LoadGridMap_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kLoadGridMap_v, wbd, true) {} };

	/// Load a set of GridMap, in the content you must write the GridMap name
        class LoadDynamicPDDL_t: public generic_whiteboard_object<std::string > { public: LoadDynamicPDDL_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kLoadDynamicPDDL_v, true) {}
		LoadDynamicPDDL_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kLoadDynamicPDDL_v, wbd, true) {} };

	/// Load a PDDL file generated previously, in the content you must write the PDDL filename
        class LoadPDDL_t: public generic_whiteboard_object<std::string > { public: LoadPDDL_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kLoadPDDL_v, true) {}
		LoadPDDL_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kLoadPDDL_v, wbd, true) {} };

	/// start the planner. The content is the desired Planner: regression or lama
        class StartPlanner_t: public generic_whiteboard_object<std::string > { public: StartPlanner_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kStartPlanner_v, true) {}
		StartPlanner_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kStartPlanner_v, wbd, true) {} };

	/// and anything on content to exit the module
        class ExitModule_t: public generic_whiteboard_object<std::string > { public: ExitModule_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kExitModule_v, true) {}
		ExitModule_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kExitModule_v, wbd, true) {} };

	/// have the next action that the robot can do
        class NextAction_t: public generic_whiteboard_object<std::string > { public: NextAction_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kNextAction_v, true) {}
		NextAction_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kNextAction_v, wbd, true) {} };

	/// the x,y coordinates on the content, for update the adyacency map and the pddl files, and do replanning
        class Replanning_t: public generic_whiteboard_object<std::string > { public: Replanning_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kReplanning_v, true) {}
		Replanning_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kReplanning_v, wbd, true) {} };

	/// to do the GridMap load, the pddl load and the planner start. In content put the GridMap.map file name
        class DoAll_t: public generic_whiteboard_object<std::string > { public: DoAll_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kDoAll_v, true) {}
		DoAll_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kDoAll_v, wbd, true) {} };

	/// to check if an obstacle is know by the robot
        class IsObstacleKnow_t: public generic_whiteboard_object<std::string > { public: IsObstacleKnow_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kIsObstacleKnow_v, true) {}
		IsObstacleKnow_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kIsObstacleKnow_v, wbd, true) {} };

	/// to generate a policy depending on the environment
        class GeneratePolicy_t: public generic_whiteboard_object<std::string > { public: GeneratePolicy_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(wbd, kGeneratePolicy_v, true) {}
		GeneratePolicy_t(std::string value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<std::string >(value, kGeneratePolicy_v, wbd, true) {} };
