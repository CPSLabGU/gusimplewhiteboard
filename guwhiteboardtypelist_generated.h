...
//Generated on: Thu Apr 18 13:40:30 2013
...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///WB interface for sending motion commands to the SDK
        class MOTION_SDK_Commands_t: public generic_whiteboard_object<class MOTION_SDK_Interface > { public: MOTION_SDK_Commands_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class MOTION_SDK_Interface >(wbd, kMOTION_SDK_Commands_v) {} };

	///WB interface for checking the status of commands sent to the SDK
        class MOTION_SDK_Status_t: public generic_whiteboard_object<class MOTION_SDK_Interface > { public: MOTION_SDK_Status_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class MOTION_SDK_Interface >(wbd, kMOTION_SDK_Status_v) {} };
	...
	/// what palyer number is this robocup whearing at RoboCup in its back, retrieved from data/playernumber and posted by the UDPreceiver
        class PlayerNumber_t: public generic_whiteboard_object<int > { public: PlayerNumber_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kPlayerNumber_v) {}
		PlayerNumber_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kPlayerNumber_v, wbd) {} };

	///control various attributes of the vision pipeline.
        class Vision_Control_t: public generic_whiteboard_object<class VisionControlStatus > { public: Vision_Control_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class VisionControlStatus >(wbd, kVision_Control_v) {} };

	///message sent by vision that contains the current status of vision
        class Vision_Status_t: public generic_whiteboard_object<class VisionControlStatus > { public: Vision_Status_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class VisionControlStatus >(wbd, kVision_Status_v) {} };
