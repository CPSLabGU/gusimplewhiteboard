...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: 3DInput @brief for 3d input devices such as the leap or a joystick */ 
        ...
        class 3DInput_t: public generic_whiteboard_object<class 3DInput > { 
	public: 
		/** Constructor: 3DInput */ 
		3DInput_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class 3DInput >(wbd, k3DInput_v, false) {} 
	};
