...
//Generated on: Tue May 14 14:15:07 2013
...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///Posts the sonar readings via the DCM loop (read only)
        class SENSORS_LeftSonarSensors_t: public generic_whiteboard_object<class SENSORS_SonarSensors > { public: SENSORS_LeftSonarSensors_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class SENSORS_SonarSensors >(wbd, kSENSORS_LeftSonarSensors_v, false) {} };
	...
	///Class that contains the Karman filtered  information of objects sightings
        class FVOsighting_t: public generic_whiteboard_object<class FilteredVisionObjects > { public: FVOsighting_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FilteredVisionObjects >(wbd, kFVOsighting_v, false) {} };
	...
	///Posts the sonar readings via the DCM loop (read only)
        class SENSORS_RightSonarSensors_t: public generic_whiteboard_object<class SENSORS_SonarSensors > { public: SENSORS_RightSonarSensors_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class SENSORS_SonarSensors >(wbd, kSENSORS_RightSonarSensors_v, false) {} };
