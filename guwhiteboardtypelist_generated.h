...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	///Class that contains boolean for checking if dead reckoning walks is running in  WEBOTS trough a bridge
        class WEBOTS_NXT_deadReakoning_walk_isRunning_t: public generic_whiteboard_object<class WEBOTS_NXT_deadReakoning_walk_isRunning > { 
	public: 
		WEBOTS_NXT_deadReakoning_walk_isRunning_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class WEBOTS_NXT_deadReakoning_walk_isRunning >(wbd, kWEBOTS_NXT_deadReakoning_walk_isRunning_v, false) {} 
	};

	///Class that contains boolean for checking if dead reckoning walks is running in  WEBOTS trough a bridge
        class WEBOTS_NXT_deadReakoning_walk_isRunning_iTCP: public injection_whiteboard_object<class WEBOTS_NXT_deadReakoning_walk_isRunning > { 
	public: 
		WEBOTS_NXT_deadReakoning_walk_isRunning_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class WEBOTS_NXT_deadReakoning_walk_isRunning >(hostname, kWEBOTS_NXT_deadReakoning_walk_isRunning_v, is_async) {} 
	};
