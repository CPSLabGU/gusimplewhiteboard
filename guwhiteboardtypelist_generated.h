...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/// dummy msg Not used
        class dummy_t: public generic_whiteboard_object<int > { 
	public: 
		dummy_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kdummy_v, true) {}
		dummy_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kdummy_v, wbd, true) {} 
	};
	...
	///Class that contains the Kalman filtered top and bottom ball objects after sighting from vision
        class FilteredBallSighting_t: public generic_whiteboard_object<class FilteredOneDimObjects > { 
	public: 
		FilteredBallSighting_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class FilteredOneDimObjects >(wbd, kFilteredBallSighting_v, false) {} 
	};
