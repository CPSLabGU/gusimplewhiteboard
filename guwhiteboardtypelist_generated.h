...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/// class:CustClass example removed, for an example see the class:FOO defintitions below -- THIS IDENTIFIER CAN BE REUSED
        class CustomClassExample_t: public generic_whiteboard_object<bool > { public: CustomClassExample_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<bool >(wbd, kCustomClassExample_v, true) {}
		CustomClassExample_t(bool value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<bool >(value, kCustomClassExample_v, wbd, true) {} };
	...
	/// what palyer number is this robot wearing at RoboCup in its back whn manually penalized, from GameController FSM sent to the UDPreceiver to forward to the JAVA referee
        class ManuallyPenalized_t: public generic_whiteboard_object<int > { public: ManuallyPenalized_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kManuallyPenalized_v, true) {}
		ManuallyPenalized_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kManuallyPenalized_v, wbd, true) {} };
