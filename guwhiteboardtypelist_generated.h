...
#include "guwhiteboardtypelist_c_generated.h"
	...
	/** WB Ptr Class: <<<<<<< HEAD @brief <<<<<<< HEAD */ 
        class <<<<<<< HEAD_t: public generic_whiteboard_object<<<<<<<< HEAD > { 
	public: 
		/** Constructor: <<<<<<< HEAD */ 
		<<<<<<< HEAD_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<<<<<<<< HEAD >(wbd, k<<<<<<< HEAD_v, false) {}
		/** Constructor: <<<<<<< HEAD */ 
		<<<<<<< HEAD_t(<<<<<<< HEAD value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<<<<<<<< HEAD >(value, k<<<<<<< HEAD_v, wbd, false) {} 
	};
	...
	/** WB Ptr Class: Ball_Calibration_Num @brief number (size_t) to load with DLC file for STEM6 DetectBallColor */ 
        class Ball_Calibration_Num_t: public generic_whiteboard_object<int > { 
	public: 
		/** Constructor: Ball_Calibration_Num */ 
		Ball_Calibration_Num_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kBall_Calibration_Num_v, false) {}
		/** Constructor: Ball_Calibration_Num */ 
		Ball_Calibration_Num_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kBall_Calibration_Num_v, wbd, false) {} 
	};

	/** WB Ptr Class: Ball_Color_Num @brief number for each ball color as defined in STEM6Master */ 
        class Ball_Color_Num_t: public generic_whiteboard_object<int > { 
	public: 
		/** Constructor: Ball_Color_Num */ 
		Ball_Color_Num_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kBall_Color_Num_v, false) {}
		/** Constructor: Ball_Color_Num */ 
		Ball_Color_Num_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kBall_Color_Num_v, wbd, false) {} 
	};
