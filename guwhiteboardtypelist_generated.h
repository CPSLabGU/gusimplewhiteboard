...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: VisionFace @brief Face seen by Vision */ 
        ...
        class VisionFace_t: public generic_whiteboard_object<class Point2D > { 
	public: 
		/** Constructor: VisionFace */ 
		VisionFace_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class Point2D >(wbd, kVisionFace_v, true) {} 
	};
