...
//Generated on: Sun Apr 28 15:32:09 2013
...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/// class:CustClass example removed, for an example see the class:FOO defintitions below -- THIS INDEX CAN BE REUSED
        class CustomClassExample_t: public generic_whiteboard_object<bool > { public: CustomClassExample_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<bool >(wbd, kCustomClassExample_v, false) {}
		CustomClassExample_t(bool value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<bool >(value, kCustomClassExample_v, wbd, false) {} };
	...
	///Class used to interact with the walk engine (UNSW)
        class WALK_Status_t: public generic_whiteboard_object<class WALK_Status > { public: WALK_Status_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class WALK_Status >(wbd, kWALK_Status_v, false) {} };
