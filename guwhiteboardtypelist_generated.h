...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	public: 
		...
		MicrowaveStatus_t(gu_simple_whiteboard_descriptor *wbd = NULL) : generic_whiteboard_object<class MicrowaveStatus >(wbd, kMicrowaveStatus_v, false) {} 
	};
	...
	/** WB Ptr Class: ToGear @brief Target gear number for Model Checking Case Study */ 
        class ToGear_t: public generic_whiteboard_object<int > { 
	public: 
		/** Constructor: ToGear */ 
		ToGear_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kToGear_v, false) {}
		/** Constructor: ToGear */ 
		ToGear_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kToGear_v, wbd, false) {} 
	};

	/** WB Ptr Class: FromGear @brief Current gear number for Model Checking Case Study */ 
        class FromGear_t: public generic_whiteboard_object<int > { 
	public: 
		/** Constructor: FromGear */ 
		FromGear_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kFromGear_v, false) {}
		/** Constructor: FromGear */ 
		FromGear_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kFromGear_v, wbd, false) {} 
	};

	/** WB Ptr Class: ErrorStat @brief Error status in Clutch for Model Checking Case Study */ 
        class ErrorStat_t: public generic_whiteboard_object<int > { 
	public: 
		/** Constructor: ErrorStat */ 
		ErrorStat_t(gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(wbd, kErrorStat_v, false) {}
		/** Constructor: ErrorStat */ 
		ErrorStat_t(int value, gu_simple_whiteboard_descriptor *wbd = NULL): generic_whiteboard_object<int >(value, kErrorStat_v, wbd, false) {} 
	};
