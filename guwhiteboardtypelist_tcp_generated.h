...
//Generated on: Fri Apr  7 23:00:49 2017
...
#include "guwhiteboardtypelist_c_generated.h"
	...
	/** WB Ptr Class: <<<<<<< HEAD @brief <<<<<<< HEAD */ 
        class <<<<<<< HEAD_iTCP: public injection_whiteboard_object<<<<<<<< HEAD > { 
	public: 
		/** Constructor: <<<<<<< HEAD */ 
		<<<<<<< HEAD_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<<<<<<<< HEAD >(hostname, k<<<<<<< HEAD_v, is_async) {}
		/** Constructor: <<<<<<< HEAD */ 
		<<<<<<< HEAD_iTCP(<<<<<<< HEAD value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<<<<<<<< HEAD >(value, hostname, k<<<<<<< HEAD_v, is_async) {} 
	};
	...
	/** WB Ptr Class: Ball_Calibration_Num @brief number (size_t) to load with DLC file for STEM6 DetectBallColor */ 
        class Ball_Calibration_Num_iTCP: public injection_whiteboard_object<int > { 
	public: 
		/** Constructor: Ball_Calibration_Num */ 
		Ball_Calibration_Num_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(hostname, kBall_Calibration_Num_v, is_async) {}
		/** Constructor: Ball_Calibration_Num */ 
		Ball_Calibration_Num_iTCP(int value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(value, hostname, kBall_Calibration_Num_v, is_async) {} 
	};

	/** WB Ptr Class: Ball_Color_Num @brief number for each ball color as defined in STEM6Master */ 
        class Ball_Color_Num_iTCP: public injection_whiteboard_object<int > { 
	public: 
		/** Constructor: Ball_Color_Num */ 
		Ball_Color_Num_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(hostname, kBall_Color_Num_v, is_async) {}
		/** Constructor: Ball_Color_Num */ 
		Ball_Color_Num_iTCP(int value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(value, hostname, kBall_Color_Num_v, is_async) {} 
	};
