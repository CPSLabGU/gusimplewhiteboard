...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/// Just a hook for an xeyes interface
        class XEyesPos_iTCP: public injection_whiteboard_object<std::vector<int> > { 
	public: 
		XEyesPos_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<std::vector<int> >(hostname, kXEyesPos_v, is_async) {}
		XEyesPos_iTCP(std::vector<int> value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<std::vector<int> >(value, hostname, kXEyesPos_v, is_async) {} 
	};
