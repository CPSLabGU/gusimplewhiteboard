...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: Giraff_MainSerialInterface @brief Serial interface for the main motor and sensor board of the giraff */ 

        class Giraff_MainSerialInterface_iTCP: public injection_whiteboard_object<class Giraff_MainSerialInterface > { 
	public: 
		/** Constructor: Giraff_MainSerialInterface */ 
		Giraff_MainSerialInterface_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class Giraff_MainSerialInterface >(hostname, kGiraff_MainSerialInterface_v, is_async) {} 
	};
