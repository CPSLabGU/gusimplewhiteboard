...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: DifferentialRobotStatus @brief Class that reads differential robot status */ 
        ...
        class DifferentialRobotStatus_iTCP: public injection_whiteboard_object<class DifferentialRobotStatus > { 
	public: 
		/** Constructor: DifferentialRobotStatus */ 
		DifferentialRobotStatus_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class DifferentialRobotStatus >(hostname, kDifferentialRobotStatus_v, is_async) {} 
	};
