...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/// dummy msg Not used
        class dummy_iTCP: public injection_whiteboard_object<int > { 
	public: 
		dummy_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(hostname, kdummy_v, is_async) {}
		dummy_iTCP(int value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(value, hostname, kdummy_v, is_async) {} 
	};
	...
	///Class that contains the Kalman filtered top and bottom ball objects after sighting from vision
        class FilteredBallSighting_iTCP: public injection_whiteboard_object<class FilteredOneDimObjects > { 
	public: 
		FilteredBallSighting_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class FilteredOneDimObjects >(hostname, kFilteredBallSighting_v, is_async) {} 
	};
