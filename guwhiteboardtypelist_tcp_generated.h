...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: Switch_Subsumption @brief class:Switch_Subsumption, nonatomic, Switch_Subsumption, "Switch_Subsumption" */ 

        class Switch_Subsumption_iTCP: public injection_whiteboard_object<class Switch_Subsumption > { 
	public: 
		/** Constructor: Switch_Subsumption */ 
		Switch_Subsumption_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class Switch_Subsumption >(hostname, kSwitch_Subsumption_v, is_async) {} 
	};
