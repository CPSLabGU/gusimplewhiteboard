...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: 3DInput @brief for 3d input devices such as the leap or a joystick */ 

        class 3DInput_iTCP: public injection_whiteboard_object<class 3DInput > { 
	public: 
		/** Constructor: 3DInput */ 
		3DInput_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class 3DInput >(hostname, k3DInput_v, is_async) {} 
	};
