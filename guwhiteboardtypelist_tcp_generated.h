...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: TurnGreenEW @brief third status of the recommendaiton of the EW light */ 
        class TurnGreenEW_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: TurnGreenEW */ 
		TurnGreenEW_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kTurnGreenEW_v, is_async) {}
		/** Constructor: TurnGreenEW */ 
		TurnGreenEW_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kTurnGreenEW_v, is_async) {} 
	};
