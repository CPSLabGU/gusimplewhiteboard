...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: VisionFace @brief Face seen by Vision */ 
        ...
        class VisionFace_iTCP: public injection_whiteboard_object<class Point2D > { 
	public: 
		/** Constructor: VisionFace */ 
		VisionFace_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class Point2D >(hostname, kVisionFace_v, is_async) {} 
	};
