...
#include "guwhiteboardtypelist_c_generated.h"                         
	...
	/** WB Ptr Class: MicrowaveStatus @brief Class for reading a simple microwave state */ 

        class MicrowaveStatus_iTCP: public injection_whiteboard_object<class MicrowaveStatus > { 
	public: 
		/** Constructor: MicrowaveStatus */ 
		MicrowaveStatus_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class MicrowaveStatus >(hostname, kMicrowaveStatus_v, is_async) {} 
	};
	...
	/** WB Ptr Class: ToGear @brief Target gear number for Model Checking Case Study */ 
        class ToGear_iTCP: public injection_whiteboard_object<int > { 
	public: 
		/** Constructor: ToGear */ 
		ToGear_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(hostname, kToGear_v, is_async) {}
		/** Constructor: ToGear */ 
		ToGear_iTCP(int value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(value, hostname, kToGear_v, is_async) {} 
	};

	/** WB Ptr Class: FromGear @brief Current gear number for Model Checking Case Study */ 
        class FromGear_iTCP: public injection_whiteboard_object<int > { 
	public: 
		/** Constructor: FromGear */ 
		FromGear_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(hostname, kFromGear_v, is_async) {}
		/** Constructor: FromGear */ 
		FromGear_iTCP(int value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(value, hostname, kFromGear_v, is_async) {} 
	};

	/** WB Ptr Class: ErrorStat @brief Error status in Clutch for Model Checking Case Study */ 
        class ErrorStat_iTCP: public injection_whiteboard_object<int > { 
	public: 
		/** Constructor: ErrorStat */ 
		ErrorStat_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(hostname, kErrorStat_v, is_async) {}
		/** Constructor: ErrorStat */ 
		ErrorStat_iTCP(int value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int >(value, hostname, kErrorStat_v, is_async) {} 
	};
