...
//Generated on: Wed Jan 17 22:45:32 2018
...
#include "guwhiteboardtypelist_c_generated.h"
	...
	/** WB Ptr Class: REMOVED1 @brief Old class, can be removed from tsl file during the next wb version bump */ 
        class REMOVED1_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: REMOVED1 */ 
		REMOVED1_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kREMOVED1_v, is_async) {}
		/** Constructor: REMOVED1 */ 
		REMOVED1_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kREMOVED1_v, is_async) {} 
	};

	/** WB Ptr Class: REMOVED2 @brief Old class, can be removed from tsl file during the next wb version bump */ 
        class REMOVED2_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: REMOVED2 */ 
		REMOVED2_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kREMOVED2_v, is_async) {}
		/** Constructor: REMOVED2 */ 
		REMOVED2_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kREMOVED2_v, is_async) {} 
	};
	...
	/** WB Ptr Class: PlayerNumber @brief what player number is this robot wearing at RoboCup in its back, retrieved from data/playernumber and posted by the UDPreceiver */ 
        class PlayerNumber_iTCP: public injection_whiteboard_object<int8_t > { 
	public: 
		/** Constructor: PlayerNumber */ 
		PlayerNumber_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(hostname, kPlayerNumber_v, is_async) {}
		/** Constructor: PlayerNumber */ 
		PlayerNumber_iTCP(int8_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(value, hostname, kPlayerNumber_v, is_async) {} 
	};
	...
	/** WB Ptr Class: ManuallyPenalized @brief what player number is this robot wearing at RoboCup in its back whn manually penalized, from GameController FSM sent to the UDPreceiver to forward to the JAVA referee */ 
        class ManuallyPenalized_iTCP: public injection_whiteboard_object<int8_t > { 
	public: 
		/** Constructor: ManuallyPenalized */ 
		ManuallyPenalized_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(hostname, kManuallyPenalized_v, is_async) {}
		/** Constructor: ManuallyPenalized */ 
		ManuallyPenalized_iTCP(int8_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(value, hostname, kManuallyPenalized_v, is_async) {} 
	};
	...
	/** WB Ptr Class: FilteredBallSighting @brief Class that contains the Kalman filtered top and bottom ball objects after sighting from vision */ 
        ...
        class FilteredBallSighting_iTCP: public injection_whiteboard_object<class FilteredArrayBallSightings > { 
	public: 
		/** Constructor: FilteredBallSighting */ 
		FilteredBallSighting_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class FilteredArrayBallSightings >(hostname, kFilteredBallSighting_v, is_async) {} 
	};
	...
	/** WB Ptr Class: PF_ControlStatus_Modes @brief what to post in the whiteboard to cause the Particle Filetr to reset, but running has no effect, it is the PF response */ 
        class PF_ControlStatus_Modes_iTCP: public injection_whiteboard_object<int32_t > { 
	public: 
		/** Constructor: PF_ControlStatus_Modes */ 
		PF_ControlStatus_Modes_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int32_t >(hostname, kPF_ControlStatus_Modes_v, is_async) {}
		/** Constructor: PF_ControlStatus_Modes */ 
		PF_ControlStatus_Modes_iTCP(int32_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int32_t >(value, hostname, kPF_ControlStatus_Modes_v, is_async) {} 
	};
	...
	/** WB Ptr Class: TeleoperationConnection @brief "Integer indication which remote whiteboard teleoperation instructions are on" */ 
        class TeleoperationConnection_iTCP: public injection_whiteboard_object<int8_t > { 
	public: 
		/** Constructor: TeleoperationConnection */ 
		TeleoperationConnection_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(hostname, kTeleoperationConnection_v, is_async) {}
		/** Constructor: TeleoperationConnection */ 
		TeleoperationConnection_iTCP(int8_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(value, hostname, kTeleoperationConnection_v, is_async) {} 
	};

	/** WB Ptr Class: UDPWBNumber @brief "ID number being used to broadcast udp whiteboard" */ 
        class UDPWBNumber_iTCP: public injection_whiteboard_object<int8_t > { 
	public: 
		/** Constructor: UDPWBNumber */ 
		UDPWBNumber_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(hostname, kUDPWBNumber_v, is_async) {}
		/** Constructor: UDPWBNumber */ 
		UDPWBNumber_iTCP(int8_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(value, hostname, kUDPWBNumber_v, is_async) {} 
	};
	...
	/** WB Ptr Class: REMOVED3 @brief Old class, can be removed from tsl file during the next wb version bump */ 
        class REMOVED3_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: REMOVED3 */ 
		REMOVED3_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kREMOVED3_v, is_async) {}
		/** Constructor: REMOVED3 */ 
		REMOVED3_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kREMOVED3_v, is_async) {} 
	};

	/** WB Ptr Class: REMOVED4 @brief Old class, can be removed from tsl file during the next wb version bump */ 
        class REMOVED4_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: REMOVED4 */ 
		REMOVED4_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kREMOVED4_v, is_async) {}
		/** Constructor: REMOVED4 */ 
		REMOVED4_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kREMOVED4_v, is_async) {} 
	};

	/** WB Ptr Class: CBall @brief Status Message for the color of the ball */ 
        class CBall_iTCP: public injection_whiteboard_object<int8_t > { 
	public: 
		/** Constructor: CBall */ 
		CBall_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(hostname, kCBall_v, is_async) {}
		/** Constructor: CBall */ 
		CBall_iTCP(int8_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int8_t >(value, hostname, kCBall_v, is_async) {} 
	};
	...
	/** WB Ptr Class: SLOT_UNUSED @brief IoT message removed, feel free to use this slot */ 
        class SLOT_UNUSED_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: SLOT_UNUSED */ 
		SLOT_UNUSED_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kSLOT_UNUSED_v, is_async) {}
		/** Constructor: SLOT_UNUSED */ 
		SLOT_UNUSED_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kSLOT_UNUSED_v, is_async) {} 
	};
	...
	/** WB Ptr Class: SwitchSubsumptionTrafficLights @brief no comment entered */ 
	...
	/** WB Ptr Class: Ball_Found @brief whether ball is detected in STEM6 DetectBallColor */ 
        class Ball_Found_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: Ball_Found */ 
		Ball_Found_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kBall_Found_v, is_async) {}
		/** Constructor: Ball_Found */ 
		Ball_Found_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kBall_Found_v, is_async) {} 
	};

	/** WB Ptr Class: Ball_Calibration_File @brief name of DLC file to load for STEM6 DetectBallColor */ 
        class Ball_Calibration_File_iTCP: public injection_whiteboard_object<std::string > { 
	public: 
		/** Constructor: Ball_Calibration_File */ 
		Ball_Calibration_File_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<std::string >(hostname, kBall_Calibration_File_v, is_async) {}
		/** Constructor: Ball_Calibration_File */ 
		Ball_Calibration_File_iTCP(std::string value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<std::string >(value, hostname, kBall_Calibration_File_v, is_async) {} 
	};

	/** WB Ptr Class: Ball_Calibration_Num @brief number (size_t) to load with DLC file for STEM6 DetectBallColor */ 
        class Ball_Calibration_Num_iTCP: public injection_whiteboard_object<int32_t > { 
	public: 
		/** Constructor: Ball_Calibration_Num */ 
		Ball_Calibration_Num_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int32_t >(hostname, kBall_Calibration_Num_v, is_async) {}
		/** Constructor: Ball_Calibration_Num */ 
		Ball_Calibration_Num_iTCP(int32_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int32_t >(value, hostname, kBall_Calibration_Num_v, is_async) {} 
	};

	/** WB Ptr Class: Ball_Color_Num @brief number for each ball color as defined in STEM6Master */ 
        class Ball_Color_Num_iTCP: public injection_whiteboard_object<int32_t > { 
	public: 
		/** Constructor: Ball_Color_Num */ 
		Ball_Color_Num_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int32_t >(hostname, kBall_Color_Num_v, is_async) {}
		/** Constructor: Ball_Color_Num */ 
		Ball_Color_Num_iTCP(int32_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<int32_t >(value, hostname, kBall_Color_Num_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_LArmTarget_Ctrl @brief Used to control the left arm via DCM */ 

        class HAL_LArmTarget_Ctrl_iTCP: public injection_whiteboard_object<class HAL_ArmTarget > { 
	public: 
		/** Constructor: HAL_LArmTarget_Ctrl */ 
		HAL_LArmTarget_Ctrl_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_ArmTarget >(hostname, kHAL_LArmTarget_Ctrl_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_LArmTarget_Stat @brief Used to report DCM status of the left arm */ 

        class HAL_LArmTarget_Stat_iTCP: public injection_whiteboard_object<class HAL_ArmTarget > { 
	public: 
		/** Constructor: HAL_LArmTarget_Stat */ 
		HAL_LArmTarget_Stat_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_ArmTarget >(hostname, kHAL_LArmTarget_Stat_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_LArmTarget_Tolr @brief Used to set the joing angle tolerance for motion completion detection. */ 

        class HAL_LArmTarget_Tolr_iTCP: public injection_whiteboard_object<class HAL_ArmTarget > { 
	public: 
		/** Constructor: HAL_LArmTarget_Tolr */ 
		HAL_LArmTarget_Tolr_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_ArmTarget >(hostname, kHAL_LArmTarget_Tolr_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_RArmTarget_Ctrl @brief Used to control the right arm via DCM */ 

        class HAL_RArmTarget_Ctrl_iTCP: public injection_whiteboard_object<class HAL_ArmTarget > { 
	public: 
		/** Constructor: HAL_RArmTarget_Ctrl */ 
		HAL_RArmTarget_Ctrl_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_ArmTarget >(hostname, kHAL_RArmTarget_Ctrl_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_RArmTarget_Stat @brief Used to report DCM status of the right arm */ 

        class HAL_RArmTarget_Stat_iTCP: public injection_whiteboard_object<class HAL_ArmTarget > { 
	public: 
		/** Constructor: HAL_RArmTarget_Stat */ 
		HAL_RArmTarget_Stat_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_ArmTarget >(hostname, kHAL_RArmTarget_Stat_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_RArmTarget_Tolr @brief Used to set the joing angle tolerance for motion completion detection. */ 

        class HAL_RArmTarget_Tolr_iTCP: public injection_whiteboard_object<class HAL_ArmTarget > { 
	public: 
		/** Constructor: HAL_RArmTarget_Tolr */ 
		HAL_RArmTarget_Tolr_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_ArmTarget >(hostname, kHAL_RArmTarget_Tolr_v, is_async) {} 
	};

	/** WB Ptr Class: VisionFieldFeatures @brief Posts information from vision about field corners and intersections */ 

        class VisionFieldFeatures_iTCP: public injection_whiteboard_object<class VisionFieldFeatures > { 
	public: 
		/** Constructor: VisionFieldFeatures */ 
		VisionFieldFeatures_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class VisionFieldFeatures >(hostname, kVisionFieldFeatures_v, is_async) {} 
	};

	/** WB Ptr Class: WhistleBlown @brief Whistle blown flag */ 
        class WhistleBlown_iTCP: public injection_whiteboard_object<bool > { 
	public: 
		/** Constructor: WhistleBlown */ 
		WhistleBlown_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(hostname, kWhistleBlown_v, is_async) {}
		/** Constructor: WhistleBlown */ 
		WhistleBlown_iTCP(bool value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<bool >(value, hostname, kWhistleBlown_v, is_async) {} 
	};

	/** WB Ptr Class: VolumeControl @brief Variable used by SMVolumeController to control the volume via pulse audio commands */ 
        class VolumeControl_iTCP: public injection_whiteboard_object<uint8_t > { 
	public: 
		/** Constructor: VolumeControl */ 
		VolumeControl_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<uint8_t >(hostname, kVolumeControl_v, is_async) {}
		/** Constructor: VolumeControl */ 
		VolumeControl_iTCP(uint8_t value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<uint8_t >(value, hostname, kVolumeControl_v, is_async) {} 
	};

	/** WB Ptr Class: VisionRobots @brief Class that reports the robots that vision sees. */ 

        class VisionRobots_iTCP: public injection_whiteboard_object<class VisionRobots > { 
	public: 
		/** Constructor: VisionRobots */ 
		VisionRobots_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class VisionRobots >(hostname, kVisionRobots_v, is_async) {} 
	};

	/** WB Ptr Class: FieldHorizon @brief Class that reports the edge of an SPL field (the edge of the green bit) */ 

        class FieldHorizon_iTCP: public injection_whiteboard_object<class FieldHorizon > { 
	public: 
		/** Constructor: FieldHorizon */ 
		FieldHorizon_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class FieldHorizon >(hostname, kFieldHorizon_v, is_async) {} 
	};

	/** WB Ptr Class: NaoWalkCommand @brief Class that controls the latest version of the UNSW 2014 walk engine. */ 

        class NaoWalkCommand_iTCP: public injection_whiteboard_object<class NaoWalkCommand > { 
	public: 
		/** Constructor: NaoWalkCommand */ 
		NaoWalkCommand_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class NaoWalkCommand >(hostname, kNaoWalkCommand_v, is_async) {} 
	};

	/** WB Ptr Class: NaoWalkStatus @brief Status class for the latest version of the UNSW 2014 walk engine. */ 

        class NaoWalkStatus_iTCP: public injection_whiteboard_object<class NaoWalkStatus > { 
	public: 
		/** Constructor: NaoWalkStatus */ 
		NaoWalkStatus_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class NaoWalkStatus >(hostname, kNaoWalkStatus_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_LLegTarget_Ctrl @brief Used to control the left leg via DCM */ 

        class HAL_LLegTarget_Ctrl_iTCP: public injection_whiteboard_object<class HAL_LegTarget > { 
	public: 
		/** Constructor: HAL_LLegTarget_Ctrl */ 
		HAL_LLegTarget_Ctrl_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_LegTarget >(hostname, kHAL_LLegTarget_Ctrl_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_LLegTarget_Stat @brief Used to report DCM status of the left leg */ 

        class HAL_LLegTarget_Stat_iTCP: public injection_whiteboard_object<class HAL_LegTarget > { 
	public: 
		/** Constructor: HAL_LLegTarget_Stat */ 
		HAL_LLegTarget_Stat_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_LegTarget >(hostname, kHAL_LLegTarget_Stat_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_LLegTarget_Tolr @brief Used to set the joing angle tolerance for motion completion detection. */ 

        class HAL_LLegTarget_Tolr_iTCP: public injection_whiteboard_object<class HAL_LegTarget > { 
	public: 
		/** Constructor: HAL_LLegTarget_Tolr */ 
		HAL_LLegTarget_Tolr_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_LegTarget >(hostname, kHAL_LLegTarget_Tolr_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_RLegTarget_Ctrl @brief Used to control the right leg via DCM */ 

        class HAL_RLegTarget_Ctrl_iTCP: public injection_whiteboard_object<class HAL_LegTarget > { 
	public: 
		/** Constructor: HAL_RLegTarget_Ctrl */ 
		HAL_RLegTarget_Ctrl_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_LegTarget >(hostname, kHAL_RLegTarget_Ctrl_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_RLegTarget_Stat @brief Used to report DCM status of the right leg */ 

        class HAL_RLegTarget_Stat_iTCP: public injection_whiteboard_object<class HAL_LegTarget > { 
	public: 
		/** Constructor: HAL_RLegTarget_Stat */ 
		HAL_RLegTarget_Stat_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_LegTarget >(hostname, kHAL_RLegTarget_Stat_v, is_async) {} 
	};

	/** WB Ptr Class: HAL_RLegTarget_Tolr @brief Used to set the joing angle tolerance for motion completion detection. */ 

        class HAL_RLegTarget_Tolr_iTCP: public injection_whiteboard_object<class HAL_LegTarget > { 
	public: 
		/** Constructor: HAL_RLegTarget_Tolr */ 
		HAL_RLegTarget_Tolr_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true) : injection_whiteboard_object<class HAL_LegTarget >(hostname, kHAL_RLegTarget_Tolr_v, is_async) {} 
	};
