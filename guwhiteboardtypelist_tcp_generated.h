...
//Generated on: Mon Oct 31 16:33:14 2016
...
#include "guwhiteboardtypelist_c_generated.h"
	...
	/** WB Ptr Class: Detect_Ball_wb @brief name of private wb for DetectBallColor machine */ 
        class Detect_Ball_wb_iTCP: public injection_whiteboard_object<std::string > { 
	public: 
		/** Constructor: Detect_Ball_wb */ 
		Detect_Ball_wb_iTCP(const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<std::string >(hostname, kDetect_Ball_wb_v, is_async) {}
		/** Constructor: Detect_Ball_wb */ 
		Detect_Ball_wb_iTCP(std::string value, const char *hostname = (const char *)"localhost", bool is_async = true): injection_whiteboard_object<std::string >(value, hostname, kDetect_Ball_wb_v, is_async) {} 
	};
