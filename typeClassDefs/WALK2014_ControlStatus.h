...
namespace guWhiteboard
{
        ...
        public:
                ...
                WALK2014_ControlStatus &operator=(const WALK2014_ControlStatus &other) { set_walk_state(other.walk_state()); set_forward(other.forward()); set_left(other.left()); set_turn(other.turn()); set_power(other.power()); set_foot(other.foot()); set_walking_status(other.walking_status()); set_odometry(other.odometry());return *this; }

                /** comparison operator */
		inline bool operator == (const WALK2014_ControlStatus &s) 
		{
    			return (fabs(static_cast<float>(forward() - s.forward())) < DBL_EPSILON &&
				fabs(static_cast<float>(left() - s.left())) < DBL_EPSILON &&
				fabs(static_cast<float>(turn() - s.turn())) < DBL_EPSILON &&
				fabs(static_cast<float>(power() - s.power())) < DBL_EPSILON &&
				foot() == s.foot() &&
